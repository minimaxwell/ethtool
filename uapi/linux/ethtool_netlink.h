...
enum {
	...
	ETHTOOL_A_PHY_PORT_TYPE,		/* u8 */
	ETHTOOL_A_PHY_PORT_SUPPORTED,		/* bitset */
	ETHTOOL_A_PHY_PORT_INTERFACES,		/* bitset */
	ETHTOOL_A_PHY_PORT_LANES,		/* u8 */

	__ETHTOOL_A_PHY_PORT_CNT,
	ETHTOOL_A_PHY_PORT_MAX = (__ETHTOOL_A_PHY_PORT_CNT - 1)
};
